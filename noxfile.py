"""Noxfile for the ohio-unemployment project."""
...
PROJECT_NAME: str = "ohio-unemployment"
PACKAGE_NAME: str = "ohio_unemployment"
REPOSITORY_HOST: str = "github.com"
REPOSITORY_PATH: str = "56kyle/ohio-unemployment"
