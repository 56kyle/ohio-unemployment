...
**[📚 View Documentation](https://ohio-unemployment.readthedocs.io/)** | **[🐛 Report a Bug](https://github.com/56kyle/ohio-unemployment/issues)** | **[✨ Request a Feature](https://github.com/56kyle/ohio-unemployment/issues)**

---

## Installation

You can install `ohio_unemployment` via [pip](pip-documentation) from PyPI:

```bash
pip install ohio_unemployment
```

### Installation for Development

To set up `ohio_unemployment` for local development:

1.  Clone the repository:
    ```bash
    git clone https://github.com/56kyle/ohio-unemployment.git
    cd ohio-unemployment
    ```
...
# from ohio_unemployment import some_function
...
# ohio-unemployment --help
# ohio-unemployment do-something --input file.txt
```
...
Report bugs or suggest features via the [issue tracker](https://github.com/56kyle/ohio-unemployment/issues).
...
[documentation]: https://ohio-unemployment.readthedocs.io/
